...
parser = argparse.ArgumentParser(description='Build an AMI for Batch use with '
                                 'EFS. Common cloudformation infrastructure '
...
# Wait for status 2/2 as a reasonable injdicator of readiness for creating AMI
while True:
